...
Now lets pose for a minute that the people of the world decide they want to use
...
Because of the underlying technology and incentive structure of Bitcoin, if it
were used globally, the following would almost be inevitable effects from the
adoption of Bitcoin:
