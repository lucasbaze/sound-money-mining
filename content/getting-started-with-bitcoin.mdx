...
Bitcoin, but they are custodial, meaning you don't own the Bitcoin. They do.
...
I personally use the <a target="_blank" href="https://muun.com/">Muun wallet</a> as it's a
...
1. **2-2 Multisig:** This mean it takes 2 keys to send a transaction. ( This is handled
   behind the scenes and increases security. )
2. **Shared-custodial:** It's not full self-custody, because Muun will hold 1 of the 2
   keys for you. ( Also behind the scenes and increases ease of recovery )
...
5. **Lightning:** Lightning is a "layer 2" technology that sits on top of and adheres to
...
You can see [Muun's open-source code on Github](https://github.com/muun).
...
you send to a Bitcoin address, and not a Lightning address; however Muun makes this very
