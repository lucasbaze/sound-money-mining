    ...
    <section className="max-w-[650px]">
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
        ...
        <p className="my-5">
          <ol>
            <li>
              Scarce money incentivizes better decision making at every level of society.
            </li>
            ...
            <li>
              Monetary and economic transparency increases fair trade and free markets.
            </li>
            <li>
              Decentralization drives power and decision making to the local level where
              it works best.
            </li>
            <li>War needs to bear its true cost and not as a medium to make money.</li>
            <li>
              Self custody of your money enables true self sovereignty and individual
              security.
            </li>
            <li>
              Everyone should be able to preserve their wealth for their families and
              future generations.
            </li>
            <li>
              Open source banking for all increases economic partcipation and works to
