  ...
  return (
    <section className="max-w-[512px]">
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
        <p className="pb-5 my-10">Thank you for coming to this page. We're glad you're a curious one.</p>
        <p className="my-5">This is a list of 10 reasons we believe Bitcoin will usher in a new era:</p>
        <p className="my-5">
          <ol>
            ...
            <li>Self custody of your money enables true self sovereignty and individual security.</li>
            <li>Everyone should be able to preserve their wealth for their families and future generations.</li>
            <li>Open source banking for all increases economic partcipation and works to eradicate global poverty.</li>
          </ol>
        </p>
        <p className="my-5">Ultimately, we want prosperity and longevity for all and Bitcoin helps get us their.</p>
      </div>
    </section>
  );
}
